...
# 3. Install hid library to /usr/lib
# 4. nm -D /usr/local/lib/libhidapi-hidraw.so | grep hid_get_input_report
#
# python3 -m venv venv
# source venv/bin/activate
# pip install --upgrade pip
# pip install hid websocket websocket-client
#
# then
#
...
def SetEnableAll(val):
	for i in range(4): print("enable M" + str(i) + " " + str(val))
	for i in range(8): print("enable S" + str(i) + " " + str(val))
